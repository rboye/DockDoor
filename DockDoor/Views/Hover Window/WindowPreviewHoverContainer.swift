...
struct WindowPreviewHoverContainer: View {
    ...
    private func createChunkedItems(filteredIndices: [Int]) -> [[FlowItem]] {
        ...
        let singleRowSideDock = !isHorizontal && maxRows == 1
        let shouldReverse = (dockPosition == .bottom || dockPosition == .right) && !previewStateCoordinator.windowSwitcherActive && !singleRowSideDock
